...
func (r *BridgeConfigReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if bridgeConfig.GetDeletionTimestamp() != nil {
		if result, err := r.OnRemove(bridgeConfig); err != nil {
			return result, err
		}
	...
	return r.OnChange(bridgeConfig)
}

func (r *BridgeConfigReconciler) OnChange(bridgeConfig *kvnetv1alpha1.BridgeConfig) (ctrl.Result, error) {
	// TODO change
	logrus.Info("OnChange")
	return ctrl.Result{}, nil
}

func (r *BridgeConfigReconciler) OnRemove(bridgeConfig *kvnetv1alpha1.BridgeConfig) (ctrl.Result, error) {
	// TODO remove
